...
namespace EwkCorrections
{
  ...
  double getEwkCorrections(/*TString dtag, const reco::GenParticleCollection &*/edm::Handle<reco::GenParticleCollection> genParticles, const std::vector<std::vector<float>> & Table, /*const GenEventInfoProduct &*/edm::Handle<GenEventInfoProduct> eventInfo, /*double ewkCorrections_error, double rho,*/TLorentzVector Z1, TLorentzVector Z2);
}
...
//		for (unsigned int i =0; i < genParticles.size(); i++){
			...
			reco::GenParticle genParticle = *genPart;//genParticles[i];
...
// modify above code to get two genZs
