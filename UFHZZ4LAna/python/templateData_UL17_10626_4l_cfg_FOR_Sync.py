...
'/store/data/Run2017C/MuonEG/MINIAOD/UL2017_MiniAODv2-v1/260000/1D067408-BB39-E844-860C-A4D4A3523925.root',
        )
...
era = "Summer19UL17_RunBCDEF_V5_DATA"
# for HPC
...
# for hpc
dBJERFile = os.environ.get('CMSSW_BASE')+"/src/UFHZZAnalysisRun2/UFHZZ4LAna/data/Summer19UL17_JRV2_DATA.db"
# for crab
#dBJERFile = "src/UFHZZAnalysisRun2/UFHZZ4LAna/data/Summer19UL17_JRV2_DATA.db"
process.jer = cms.ESSource("PoolDBESSource",
        ...
        toGet = cms.VPSet(
            ...
            #cms.PSet(
            #    record = cms.string('JetResolutionRcd'),
            #    tag    = cms.string('JR_Summer19UL17_JRV2_DATA_PhiResolution_AK4PFchs'),
