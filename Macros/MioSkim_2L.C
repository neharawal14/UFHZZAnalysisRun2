...
void MioSkim_2L(TString fs="2mu", TString year="2018", bool max_entry=1, int set_low=0, int set_max=0, TString run="no", TString subnameIn="Run3", TString subnameOut="Run3", TString resonance="DY"){
...
if(fs == "2e")
        DataSetType.push_back("SingleElectron");	
//        DataSetType.push_back("EGamma");
...
// 
  ...
  std::vector<float> *lep_position_x = 0;
  std::vector<float> *lep_position_y = 0;
  std::vector<float> *lep_position_z = 0;
  std::vector<float> *lep_pt_FromMuonBestTrack = 0;  
  std::vector<float> *lep_eta_FromMuonBestTrack = 0;
  std::vector<float> *lep_phi_FromMuonBestTrack = 0;
  ...
  std::vector<float> *lep_isTight = 0;
  std::vector<float> *lep_isMedium = 0;
  std::vector<float> *lep_Sip = 0;
  std::vector<float> *lep_dzPV = 0;

  std::vector<double> *singleBS_RecoLep_pt = 0;
  std::vector<double> *singleBS_RecoLep_ptError = 0;
  std::vector<double> *singleBS_RecoLep_eta = 0;
  std::vector<double> *singleBS_RecoLep_phi = 0;
  std::vector<double> *singleBS_RecoLep_mass = 0;
  std::vector<double> *singleBS_RecoLep_d0 = 0;
  ...
  double massZ_single_BS, massZ_single_BS_FSR, massZErr_single_BS, massZErr_single_BS_FSR, massZ_single_BSChi2;
  ...
  double muonPV_x1, muonPV_x2;
  double muonPV_y1, muonPV_y2;
  double muonPV_z1, muonPV_z2;
  double tightPOG1, tightPOG2;
  double mediumPOG1, mediumPOG2;

  double pT1_FromMuonBestTrack, pT2_FromMuonBestTrack;
  double eta1_FromMuonBestTrack, eta2_FromMuonBestTrack;
  double phi1_FromMuonBestTrack, phi2_FromMuonBestTrack;
  double pT1_genFromReco, pT2_genFromReco;
  ...
  double single_BS_pT1, single_BS_pT2, single_BS_eta1, single_BS_eta2, single_BS_m1, single_BS_m2, single_BS_phi1, single_BS_phi2, single_BS_d01, single_BS_d02;
  double single_BS_pT_FSR1, single_BS_pT_FSR2, single_BS_eta_FSR1, single_BS_eta_FSR2, single_BS_m_FSR1, single_BS_m_FSR2, single_BS_phi_FSR1, single_BS_phi_FSR2;


  double pterr1, pterr2;
  double pterr1_single, pterr2_single;
  ...
  TString infilename;
  TString nome_file;
  infilename = "../../../Root_File/Summer20/";
  if(run == "no"){
	infilename = "/lustre/home/ferrico/Root_File/DY_Roch_s5m0/DY_" + year + "_" + subnameIn + ".root";        
  	nome_file =  "./DY_" + year + "_" + subnameOut + "_cancella.root"; 	
  }
  else{
  	infilename = "/lustre/home/ferrico/Root_File/DY_Roch_s5m0/DATA/" + DataSetType.at(0) + "_Run" + year + run + ".root";
  	nome_file = "./Data_" + DataSetType.at(0) + "_Run" + year + run + "_skimmed_" + subnameOut + ".root";
  }


nome_file = "Dati_skimmed_" + subnameOut + "_cancella_" + year + ".root";
infilename = "../../DUMMYFILENAME_dati.root";

//infilename = "/lustre/home/ferrico/Root_File/Higgs_Roch_s5m0/Data_Run2016-UL2016_" + run + "_MiniAODv2_noDuplicates.root";
//nome_file = "DATA_" + fs + "_skimmed_" + subnameOut + "_cancella_" + year + ".root";
...
TH1F* histo_weight = (TH1F*)gDirectory->Get("sumWeights");
  TFile* tmpFile =  new TFile(nome_file,"RECREATE");
 ...
 newtree->Branch("massZ_single_BS",&massZ_single_BS,"massZ_single_BS/D");
//   newtree->Branch("massZ_single_BS_FSR",&massZ_single_BS_FSR,"massZ_single_BS_FSR/D");
//   newtree->Branch("massZErr_single_BS",&massZErr_single_BS,"massZErr_single_BS/D");
//   newtree->Branch("massZErr_single_BS_FSR",&massZErr_single_BS_FSR,"massZErr_single_BS_FSR/D");
//   newtree->Branch("massZ_single_BSChi2",&massZ_single_BSChi2,"massZ_single_BSChi2/D");
...
//   newtree->Branch("massZErrOld",&massZErrOld,"massZErrOld/D");
 ...
 newtree->Branch("BsZ2",&BsZ2,"BsZ2/D");
  ...
  newtree->Branch("muonPV_x1",&muonPV_x1,"muonPV_x1/D");
  newtree->Branch("muonPV_y1",&muonPV_y1,"muonPV_y1/D");
  newtree->Branch("muonPV_z1",&muonPV_z1,"muonPV_z1/D");
  newtree->Branch("muonPV_x2",&muonPV_x2,"muonPV_x2/D");
  newtree->Branch("muonPV_y2",&muonPV_y2,"muonPV_y2/D");
  newtree->Branch("muonPV_z2",&muonPV_z2,"muonPV_z2/D");
  ...
  newtree->Branch("eta1_FromMuonBestTrack",&eta1_FromMuonBestTrack,"eta1_FromMuonBestTrack/D");
  newtree->Branch("eta2_FromMuonBestTrack",&eta2_FromMuonBestTrack,"eta2_FromMuonBestTrack/D");
  newtree->Branch("phi1_FromMuonBestTrack",&phi1_FromMuonBestTrack,"phi1_FromMuonBestTrack/D");
  newtree->Branch("phi2_FromMuonBestTrack",&phi2_FromMuonBestTrack,"phi2_FromMuonBestTrack/D");
  newtree->Branch("pT1_genFromReco",&pT1_genFromReco,"pT1_genFromReco/D");
  newtree->Branch("pT2_genFromReco",&pT2_genFromReco,"pT2_genFromReco/D");
...
newtree->Branch("tightPOG1", &tightPOG1, "tightPOG1/D");
newtree->Branch("tightPOG2", &tightPOG2, "tightPOG2/D");
newtree->Branch("mediumPOG1", &mediumPOG1, "mediumPOG1/D");
newtree->Branch("mediumPOG2", &mediumPOG2, "mediumPOG2/D");
...
//   newtree->Branch("Pixel2",&Pixel2,"Pixel2/D");
  ...
  newtree->Branch("single_BS_pT1",&single_BS_pT1,"single_BS_pT1/D");
  newtree->Branch("single_BS_pT2",&single_BS_pT2, "single_BS_pT2/D");
  newtree->Branch("single_BS_eta1",&single_BS_eta1, "single_BS_eta1/D");
  newtree->Branch("single_BS_eta2",&single_BS_eta2, "single_BS_eta2/D");
  newtree->Branch("single_BS_phi1",&single_BS_phi1, "single_BS_phi1/D");
  newtree->Branch("single_BS_phi2",&single_BS_phi2, "single_BS_phi2/D");
  newtree->Branch("single_BS_m1",&single_BS_m1, "single_BS_m1/D");
  newtree->Branch("single_BS_m2",&single_BS_m2, "single_BS_m2/D");
...
//   newtree->Branch("single_BS_pT_FSR1",&single_BS_pT_FSR1,"single_BS_pT_FSR1/D");
//   newtree->Branch("single_BS_pT_FSR2",&single_BS_pT_FSR2, "single_BS_pT_FSR2/D");
//   newtree->Branch("single_BS_eta_FSR1",&single_BS_eta_FSR1, "single_BS_eta_FSR1/D");
//   newtree->Branch("single_BS_eta_FSR2",&single_BS_eta_FSR2, "single_BS_eta_FSR2/D");
//   newtree->Branch("single_BS_phi_FSR1",&single_BS_phi_FSR1, "single_BS_phi_FSR1/D");
//   newtree->Branch("single_BS_phi_FSR2",&single_BS_phi_FSR2, "single_BS_phi_FSR2/D");
//   newtree->Branch("single_BS_m_FSR1",&single_BS_m_FSR1, "single_BS_m_FSR1/D");
//   newtree->Branch("single_BS_m_FSR2",&single_BS_m_FSR2, "single_BS_m_FSR2/D");
 ...
 newtree->Branch("vtx_pT_FSR1",&vtx_pT_FSR1,"vtx_pT_FSR1/D");
  ...
  newtree->Branch("dzPV1",&dzPV1,"dzPV1/D");
  newtree->Branch("Sip1",&Sip1,"Sip1/D");
  newtree->Branch("d0PV2",&d0PV2,"d0PV2/D"); 
  newtree->Branch("dzPV2",&dzPV2,"dzPV2/D");
...
//   newtree->Branch("pterr1_single",&pterr1_single,"pterr1_single/D");
//   newtree->Branch("pterr2_single",&pterr2_single,"pterr2_single/D");
...
//         tree->SetBranchStatus("lep_numberOfValidPixelHits",1);
        ...
        tree->SetBranchStatus("lep_position_x",1);
        tree->SetBranchStatus("lep_position_y",1);
        tree->SetBranchStatus("lep_position_z",1);
        tree->SetBranchStatus("lep_pt_FromMuonBestTrack",1);                  
        tree->SetBranchStatus("lep_eta_FromMuonBestTrack",1);                  
        tree->SetBranchStatus("lep_phi_FromMuonBestTrack",1);                  
        tree->SetBranchStatus("lep_pt_genFromReco",1);                  
        ...
        tree->SetBranchStatus("lep_pterr",1);               
				//tree->SetBranchStatus("lep_isTight",1);
				//tree->SetBranchStatus("lep_isMedium",1);
tree->SetBranchStatus("lep_Sip",1);
				//tree->SetBranchStatus(lep_dzPV",1);
...
//         tree->SetBranchStatus("met",1);                           
        ...
        tree->SetBranchStatus("singleBS_RecoLep_pt", 1);                   
        tree->SetBranchStatus("singleBS_RecoLep_ptError", 1);                   
        tree->SetBranchStatus("singleBS_RecoLep_eta", 1);                   
        tree->SetBranchStatus("singleBS_RecoLep_phi", 1);                   
        tree->SetBranchStatus("singleBS_RecoLep_mass", 1);                   
...
//         tree->SetBranchAddress("lep_numberOfValidPixelHits", &lep_numberOfValidPixelHits);
        ...
        tree->SetBranchAddress("lep_position_x", &lep_position_x);                 
        tree->SetBranchAddress("lep_position_y", &lep_position_y);                 
        tree->SetBranchAddress("lep_position_z", &lep_position_z);                 
        tree->SetBranchAddress("lep_pt_FromMuonBestTrack", &lep_pt_FromMuonBestTrack);                 
        tree->SetBranchAddress("lep_eta_FromMuonBestTrack", &lep_eta_FromMuonBestTrack);                 
        tree->SetBranchAddress("lep_phi_FromMuonBestTrack", &lep_phi_FromMuonBestTrack);                 
        tree->SetBranchAddress("lep_pt_genFromReco", &lep_pt_genFromReco);                 
        ...
        tree->SetBranchAddress("lep_pterr",&lep_pterr);           
				//tree->SetBranchAddress("lep_isTight", &lep_isTight);
				//tree->SetBranchAddress("0lep_isMedium", &lep_isMedium);
tree->SetBranchAddress("lep_Sip", &lep_Sip);
				//tree->SetBranchAddress("lep_dzPV", &lep_dzPV);
...
//         tree->SetBranchAddress("met", &met);   
        ...
        tree->SetBranchAddress("singleBS_RecoLep_pt", &singleBS_RecoLep_pt);   
        tree->SetBranchAddress("singleBS_RecoLep_ptError", &singleBS_RecoLep_ptError);   
        tree->SetBranchAddress("singleBS_RecoLep_eta", &singleBS_RecoLep_eta);   
        tree->SetBranchAddress("singleBS_RecoLep_phi", &singleBS_RecoLep_phi);   
        tree->SetBranchAddress("singleBS_RecoLep_mass", &singleBS_RecoLep_mass);   
        ...
        tree->SetBranchAddress("vtxRecoLep_BS_d0", &vtxRecoLep_BS_d0);
        tree->SetBranchAddress("vtxRecoLep_BS_pt", &vtxRecoLep_BS_pt);   
        tree->SetBranchAddress("vtxRecoLep_BS_ptError", &vtxRecoLep_BS_ptError);   
...
//std::cout<<(*lep_isTight)[L1]<<"\t"<<(*lep_isTight)[L2]<<std::endl;


//tightPOG1 = (*lep_isTight)[L1]; tightPOG2 = (*lep_isTight)[L2];
//mediumPOG1 = (*lep_isMedium)[L1]; mediumPOG2 = (*lep_isMedium)[L2];
Sip1 = (*lep_Sip)[L1]; Sip2 = (*lep_Sip)[L2];
//dzPV1 = (*lep_dzPV)[L1]; dzPV2 = (*lep_dzPV)[L2];

           pT1_FromMuonBestTrack = (*lep_pt_FromMuonBestTrack)[L1];
           pT2_FromMuonBestTrack = (*lep_pt_FromMuonBestTrack)[L2];
           eta1_FromMuonBestTrack = (*lep_eta_FromMuonBestTrack)[L1];
           eta2_FromMuonBestTrack = (*lep_eta_FromMuonBestTrack)[L2];
           phi1_FromMuonBestTrack = (*lep_phi_FromMuonBestTrack)[L1];
           phi2_FromMuonBestTrack = (*lep_phi_FromMuonBestTrack)[L2];
           
           muonPV_x1 = (*lep_position_x)[L1];
           muonPV_x2 = (*lep_position_x)[L2];
           muonPV_y1 = (*lep_position_y)[L1];
           muonPV_y2 = (*lep_position_y)[L2];
           muonPV_z1 = (*lep_position_z)[L1];
           muonPV_z2 = (*lep_position_z)[L2];

           pT1_genFromReco = (*lep_pt_genFromReco)[L1];
           pT2_genFromReco = (*lep_pt_genFromReco)[L2];
...
//             Met = met; 
			...
			TLorentzVector single_BS_Lep1, single_BS_Lep2; 
			TLorentzVector single_BS_Lep1_FSR, single_BS_Lep2_FSR; 




			/////// single BS constraint
			if(fs != "2e"){
			
				if(singleBS_RecoLep_eta->size() > 1){
					single_BS_eta1 = double((*singleBS_RecoLep_eta)[L1]); single_BS_eta2 = double((*singleBS_RecoLep_eta)[1]);
					single_BS_phi1 = double((*singleBS_RecoLep_phi)[L1]); single_BS_phi2 = double((*singleBS_RecoLep_phi)[1]); 
					single_BS_m1 = double((*singleBS_RecoLep_mass)[L1]); single_BS_m2 = double((*singleBS_RecoLep_mass)[1]);
					single_BS_pT1 = double((*singleBS_RecoLep_pt)[L1]); single_BS_pT2 = double((*singleBS_RecoLep_pt)[1]);
 
					pterr1_single = double((*singleBS_RecoLep_ptError)[L1]); pterr2_single = double((*singleBS_RecoLep_ptError)[1]);
		   
					single_BS_Lep1.SetPtEtaPhiM(single_BS_pT1, single_BS_eta1, single_BS_phi1, single_BS_m1);
					single_BS_Lep2.SetPtEtaPhiM(single_BS_pT2, single_BS_eta2, single_BS_phi2, single_BS_m2);
	
					massZ_single_BS = (single_BS_Lep1 + single_BS_Lep2).M();
	//             massZ_single_BSChi2 = massZ_single_BS_chi2;

					lep1p.SetPtEtaPhiM(double(single_BS_pT1 + pterr1_single), single_BS_eta1, single_BS_phi1, single_BS_m1);
					lep2p.SetPtEtaPhiM(double(single_BS_pT2 + pterr2_single), single_BS_eta2, single_BS_phi2, single_BS_m2);

					dm1 = (lep1p+single_BS_Lep2).M()-(single_BS_Lep1+single_BS_Lep2).M();
					dm2 = (single_BS_Lep1+lep2p).M()-(single_BS_Lep1+single_BS_Lep2).M();
 
					massZErr_single_BS = TMath::Sqrt(dm1*dm1+dm2*dm2);
						
					if((*fsrPhotons_pt).size() > 0){
						photon1.SetPtEtaPhiM((*fsrPhotons_pt)[0], (*fsrPhotons_eta)[0], (*fsrPhotons_phi)[0], 0.0);
						float DeltaR1 = sqrt(pow((*fsrPhotons_eta)[0] - single_BS_Lep1.Eta(),2) + pow((*fsrPhotons_phi)[0] - single_BS_Lep1.Phi(),2));
						if(DeltaR1 < 0.5)
							single_BS_Lep1_FSR = single_BS_Lep1 + photon1;
						else
							single_BS_Lep1_FSR = single_BS_Lep1;
						
						if((*fsrPhotons_pt).size() > 1){
							photon2.SetPtEtaPhiM((*fsrPhotons_pt)[1], (*fsrPhotons_eta)[1], (*fsrPhotons_phi)[1], 0.0);
							float DeltaR2 = sqrt(pow((*fsrPhotons_eta)[1] - single_BS_Lep2.Eta(),2) + pow((*fsrPhotons_phi)[1] - single_BS_Lep2.Phi(),2));
							if(DeltaR2 < 0.5)
								single_BS_Lep2_FSR = single_BS_Lep2 + photon2;
							else
								single_BS_Lep2_FSR = single_BS_Lep2;
						}
						else
							single_BS_Lep2_FSR = single_BS_Lep2;
					...
					single_BS_eta_FSR1 = single_BS_Lep1_FSR.Eta(); single_BS_eta_FSR2 = single_BS_Lep2_FSR.Eta();
					single_BS_phi_FSR1 = single_BS_Lep1_FSR.Phi();  single_BS_phi_FSR2 = single_BS_Lep2_FSR.Phi();
					single_BS_pT_FSR1 = single_BS_Lep1_FSR.Pt(); single_BS_pT_FSR2 =  single_BS_Lep2_FSR.Pt();
					single_BS_m_FSR1 = single_BS_Lep1_FSR.M(); single_BS_m_FSR2 = single_BS_Lep2_FSR.M();
			
					massZ_single_BS_FSR = (single_BS_Lep1_FSR + single_BS_Lep2_FSR).M();
						
					lep1p.SetPtEtaPhiM(double(single_BS_pT_FSR1 + pterr1_single), single_BS_eta_FSR1, single_BS_phi_FSR1, single_BS_m_FSR1);
					lep2p.SetPtEtaPhiM(double(single_BS_pT_FSR2 + pterr2_single), single_BS_eta_FSR2, single_BS_phi_FSR2, single_BS_m_FSR2);

					dm1 = (lep1p+single_BS_Lep2_FSR).M()-(single_BS_Lep1_FSR+single_BS_Lep2_FSR).M();
					dm2 = (single_BS_Lep1_FSR+lep2p).M()-(single_BS_Lep1_FSR+single_BS_Lep2_FSR).M();
 
					massZErr_single_BS_FSR = TMath::Sqrt(dm1*dm1+dm2*dm2);
				}
			}
			/////// single BS constraint
			...
			/////// vtx BS constraint			
            d0BS_vtx_BS1 = (*vtxRecoLep_BS_d0)[L1];
            d0BS_vtx_BS2 = (*vtxRecoLep_BS_d0)[L2];
            ...
            pterr1_VX_BS = double((*vtxRecoLep_BS_ptError)[L1]); pterr2_VX_BS = double((*vtxRecoLep_BS_ptError)[1]);
            ...
            lep1p.SetPtEtaPhiM(double(vtx_BS_pT1 + pterr1_VX_BS), vtx_BS_eta1, vtx_BS_phi1, vtx_BS_m1);
            lep2p.SetPtEtaPhiM(double(vtx_BS_pT2 + pterr2_VX_BS), vtx_BS_eta2, vtx_BS_phi2, vtx_BS_m2);

            dm1 = (lep1p+vtx_Lep2).M()-(vtx_Lep1+vtx_Lep2).M();
            dm2 = (vtx_Lep1+lep2p).M()-(vtx_Lep1+vtx_Lep2).M();
 
            massZErr_vtx_BS = TMath::Sqrt(dm1*dm1+dm2*dm2);
            ...
            lep1p.SetPtEtaPhiM(double(vtx_BS_pT_FSR1 + pterr1_VX_BS), vtx_BS_eta_FSR1, vtx_BS_phi_FSR1, vtx_BS_m_FSR1);
            lep2p.SetPtEtaPhiM(double(vtx_BS_pT_FSR2 + pterr2_VX_BS), vtx_BS_eta_FSR2, vtx_BS_phi_FSR2, vtx_BS_m_FSR2);

            dm1 = (lep1p+vtx_Lep2_FSR).M()-(vtx_Lep1_FSR+vtx_Lep2_FSR).M();
            dm2 = (vtx_Lep1_FSR+lep2p).M()-(vtx_Lep1_FSR+vtx_Lep2_FSR).M();
 
            massZErr_vtx_BS_FSR = TMath::Sqrt(dm1*dm1+dm2*dm2);
			/////// vtx BS constraint
